...
/*!**********************************!*\
  !*** ./actions/giphy_actions.js ***!
  \**********************************/
/*! exports provided: RECEIVE_SEARCH_GIFS, receiveGifs, bringGifs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RECEIVE_SEARCH_GIFS", function() { return RECEIVE_SEARCH_GIFS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "receiveGifs", function() { return receiveGifs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bringGifs", function() { return bringGifs; });
/* harmony import */ var _util_api_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/api_util */ "./util/api_util.js");

var RECEIVE_SEARCH_GIFS = "RECEIVE_SEARCH_GIFS";
var receiveGifs = function receiveGifs(giphys) {
  return {
    type: RECEIVE_SEARCH_GIFS,
    giphys: giphys
  };
};
var bringGifs = function bringGifs(wrd) {
  return function (dispatch) {
    Object(_util_api_util__WEBPACK_IMPORTED_MODULE_0__["default"])(wrd).then(function (res) {
      return dispatch(receiveGifs(res.data));
    });
  };
};
...
function (_React$Component) {
  ...
  function GiphysIndex() {
    _classCallCheck(this, GiphysIndex);

    return _possibleConstructorReturn(this, _getPrototypeOf(GiphysIndex).apply(this, arguments));
  }

  _createClass(GiphysIndex, [{
    key: "render",
    value: function render() {
      var list = this.props.gyphs.map(function (gf, idx) {
...
var GiphysIndexItem = function GiphysIndexItem(_ref) {
  var gif = _ref.gif,
      num = _ref.num;
...
function (_React$Component) {
  ...
  function GiphysSearch(props) {
    ...
    _this.updateWrd = _this.updateWrd.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        onChange: this.updateWrd,
        value: this.state.word
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        onClick: this.submit
      }, "Search"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index__WEBPACK_IMPORTED_MODULE_1__["default"], {
        gyphs: this.props.gifs
      }));
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    queryGifs: function queryGifs(wrd) {
      return dispatch(Object(_actions_giphy_actions__WEBPACK_IMPORTED_MODULE_2__["bringGifs"])(wrd));
    }
  };
};
...
var gifReducer = function gifReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case _actions_giphy_actions__WEBPACK_IMPORTED_MODULE_0__["RECEIVE_SEARCH_GIFS"]:
...
/* harmony default export */ __webpack_exports__["default"] = (gifReducer);
...
var reducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  giphs: _giphys_reducer__WEBPACK_IMPORTED_MODULE_1__["default"]
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var getGif = function getGif(wrd) {
  return $.ajax({
    method: "GET",
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(wrd, "&api_key=", 'pyMYNFRnSdJEDubZ6K9ZeX85RY8prDTF', "&limit=2")
  });
};

/* harmony default export */ __webpack_exports__["default"] = (getGif);
