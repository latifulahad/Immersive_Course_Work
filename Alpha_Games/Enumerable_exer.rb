...
def factors(num)
  arr = []
  (1..num).each { |el| arr << el if num % el == 0 }
  arr 
end
...
def substrings(string)
  arr = [string[0]]
  holder = ""
  string.chars.each_with_index do |el, i|
    string.chars.each_with_index do |ele, i2|
      if i2 > i 
        arr << holder += string[i..i2]
      end
    end
  end 
  arr.push(string[-1])
...
#[1, 2, 3].my_each { |el| puts el }.my_each { |el| puts el }
#SUCCESS
